 ...
 */
public class FacstudentsSearch1 extends javax.swing.JFrame {

    
    public FacstudentsSearch1() {
        initComponents();
        findUsers();
    }
   //Defining Uni Variables
    int ButtonId=0;
    String Searchquery;
...
public void findUsers(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacstudentsSearch1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacstudentsSearch1().setVisible(true);
            }
        });
    }
