 ...
 */
public class CourseSearch1 extends javax.swing.JFrame {

    public CourseSearch1() {
        initComponents();
        findUsers();
    }
  ...
  private Connection conn=null;
   ...
   public ArrayList<Course> ListUsers(int id, String valtosearch){
        ArrayList usersList = new ArrayList<Course>();
        Statement st;
        ResultSet rs;
        ...
        try{
            ...
            if (id==0){
                Searchquery="SELECT * FROM course WHERE CONCAT(CourseID,CName,Fees,Sub1,Sub2,Sub3,Sub4,TeacherID) LIKE '%"+valtosearch+"%';";
            }else if(id==2){
            Searchquery="SELECT * FROM course WHERE CourseID="+valtosearch+";";
        }
...
public void findUsers(){
        ArrayList<Course> Courses = ListUsers(ButtonId,jText_Search.getText());
        DefaultTableModel model =new DefaultTableModel();//CourseID CName Fees Sub1 Sub2 Sub3 Sub4 TeacherID
        model.setColumnIdentifiers(new Object[]{"Course ID","Name","Fees","Sub1","Sub2","Sub3","Sub4","TeacherID"});
       
        Object[] row = new Object[8];
        for (int i=0; i<Courses.size(); i++){
            row[0]=Courses.get(i).getId();
            row[1]=Courses.get(i).getCname();
            row[2]=Courses.get(i).getFees();
            row[3]=Courses.get(i).getSub1();
            row[4]=Courses.get(i).getSub2();
            row[5]=Courses.get(i).getSub3();
            row[6]=Courses.get(i).getSub4();
            row[7]=Courses.get(i).getTeacherID();
            model.addRow(row);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CourseSearch1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CourseSearch1().setVisible(true);
            }
        });
    }
